...
while (($#)); do
  case "$1" in
    ...
    -h|--help) show_help; exit 0 
      ;;
    -[012345ayfrmMtcqvDh]*) #shellcheck disable=SC2046 #split up single options
